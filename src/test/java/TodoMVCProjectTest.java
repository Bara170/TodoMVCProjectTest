...
//        input.sendKeys("Original Item");
//        input.sendKeys(Keys.ENTER);
//
//        // Step 2: Wait for the label to appear
//        WebElement label = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[data-testid='todo-item-label']")));
//        assertEquals("Original Item", label.getText());
//
//        // Step 3: Double-click the label
//        actions.doubleClick(label).perform();
//
//        // Step 4: Input new text
//        WebElement editInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("li.editing input.edit")));
//        editInput.clear();
//        editInput.sendKeys("Modified Item");
//        editInput.sendKeys(Keys.ENTER);
//
//        // Step 5: Confirm the label now shows updated text
//        WebElement modifiedLabel = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[data-testid='todo-item-label']")));
//        assertEquals("Modified Item", modifiedLabel.getText());

        // Screenshot of MODIFIED item
        takeScreenshot(driver, "modified_item.png");
